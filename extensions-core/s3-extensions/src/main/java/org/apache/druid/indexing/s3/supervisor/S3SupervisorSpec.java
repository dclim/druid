...
public class S3SupervisorSpec implements SupervisorSpec
{
  ...
  @JsonCreator
  public S3SupervisorSpec(
      @JsonProperty("dataSchema") DataSchema dataSchema,
      @JsonProperty("tuningConfig") S3SupervisorTuningConfig tuningConfig,
      @JsonProperty("ioConfig") S3SupervisorIOConfig ioConfig,
  ...
  @JsonProperty
  public S3SupervisorTuningConfig getTuningConfig()
  {
    return tuningConfig;
  }

  @JsonProperty
  public S3SupervisorIOConfig getIoConfig()
  {
    return ioConfig;
  }
